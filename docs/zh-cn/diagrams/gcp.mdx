---
title: GCP
description: GCP 架构图，展示 VPC、GKE、Cloud Functions、Cloud SQL 以及与 F5 XC 集成的全局负载均衡。
sidebar:
  order: 12
i18n:
...
使用 HashiCorp Flight 和 Carbon 图标包绘制的 Google Cloud 基础设施图，涵盖 VPC 网络、GKE 及托管服务。

## GCP VPC 与 GKE

Google Cloud 项目，全局负载均衡器将流量分发至 GKE 集群和 Cloud Functions。
...
GKE 集群结合 F5 分布式云，跨云环境提供应用连接与可观测性。
...
GCP 无服务器数据处理管道，包含 Pub/Sub、Cloud Functions 和 BigQuery。
