...
title: Kubernetes
description: >-
  مخططات هيكلية لـ Kubernetes تعرض وحدات تحكم الدخول، وشبكة الخدمات، وشبكات
  الحاويات، وأمان الحاويات مع NGINX.
sidebar:
  order: 19
i18n:
...
مخططات هيكلية لـ Kubernetes تغطي وحدات تحكم الدخول، وأنماط شبكة الخدمات، وشبكات الحاويات، وأمان الحاويات مع تكامل NGINX وF5 XC.

## Kubernetes Ingress مع NGINX

تطبيق قائم على الحاويات مع وحدة تحكم دخول NGINX توزع حركة المرور على حاويات الواجهة الأمامية والخلفية.
...
## شبكة الخدمات مع F5 XC

شبكة خدمات Kubernetes مع F5 XC توفر موازنة التحميل الخارجية، وقابلية المراقبة، والاتصال متعدد المجموعات.
...
## خط أنابيب نشر الحاويات

خط أنابيب CI/CD لنشر Kubernetes باستخدام مخططات Helm، وسجل الحاويات، والطرح التلقائي.
