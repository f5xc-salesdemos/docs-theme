---
title: علامة F5 التجارية
description: >-
  مخططات عرض أيقونات منتجات F5 التي تتضمن خدمات XC وخط منتجات NGINX وBIG-IP
  وأيقونات شبكات F5 السحابية.
sidebar:
  order: 21
i18n:
...
مخططات عرض أيقونات منتجات F5 التي توضح محفظة خدمات F5 XC وخط منتجات NGINX وقدرات BIG-IP باستخدام حزمتَي الأيقونات `f5xc` و`f5-brand`.

## محفظة خدمات F5 XC

نظرة عامة على خدمات F5 Distributed Cloud التي تشمل الأمان والشبكات وتوصيل التطبيقات.
...
مجموعة أمان F5 XC الكاملة مع WAAP ودفاع Bot والدفاع من جهة العميل وحماية DDoS واكتشاف API.
...
خدمات شبكات F5 Distributed Cloud مع الاتصال متعدد السحابات وإدارة DNS والتطبيقات الموزعة.
...
## قابلية مراقبة F5 XC والذكاء

قابلية مراقبة F5 Distributed Cloud وتحليل حركة المرور وذكاء البيانات لتحقيق رؤية شاملة للتطبيقات.
