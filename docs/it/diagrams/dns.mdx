...
title: DNS
description: >-
  Diagrammi di risoluzione DNS inclusi risoluzione ricorsiva, GSLB e gestione
  DNS F5 XC.
sidebar:
  order: 14
i18n:
...
Risoluzione standard delle query DNS dal client attraverso il resolver ricorsivo fino al nameserver autorevole con integrazione GSLB.
...
Gestione DNS di F5 Distributed Cloud che fornisce bilanciamento del carico DNS intelligente tra origini multi-cloud.
...
## Architettura di Bilanciamento del Carico DNS

Bilanciamento del carico DNS multi-livello con routing geografico, controlli di integrità e failover tra regioni cloud.
