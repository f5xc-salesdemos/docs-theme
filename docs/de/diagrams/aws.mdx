...
title: AWS
description: >-
  AWS-Architekturdiagramme mit VPC, Subnetzen, ALB, EC2, EKS, Lambda und
  S3-Topologien mit F5 XC-Integration.
sidebar:
  order: 10
i18n:
...
AWS-Infrastrukturdiagramme mit den Icon-Paketen HashiCorp Flight und Carbon für VPC-Netzwerk-, Compute- und Serverless-Architekturen.

## VPC mit ALB und EC2

Öffentliche und private Subnetze mit Application Load Balancer, der den Datenverkehr auf EC2-Instanzen verteilt, die durch RDS unterstützt werden.
...
## EKS-Cluster mit F5 XC WAAP

Amazon EKS-Cluster mit F5 Distributed Cloud, der Web-Applikations- und API-Schutz am Edge bereitstellt.
...
AWS Lambda verarbeitet Ereignisse aus S3 mit API-Gateway-Frontend, geschützt durch F5 XC.
