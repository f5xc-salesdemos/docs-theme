...
title: DNS
description: >-
  DNS रिज़ॉल्यूशन डायग्राम जिसमें रिकर्सिव रिज़ॉल्यूशन, GSLB, और F5 XC DNS
  प्रबंधन शामिल हैं।
sidebar:
  order: 14
i18n:
...
DNS आर्किटेक्चर डायग्राम जो रिकर्सिव रिज़ॉल्यूशन फ़्लो, ग्लोबल सर्वर लोड बैलेंसिंग, और F5 Distributed Cloud DNS प्रबंधन को कवर करते हैं।

## DNS रिज़ॉल्यूशन फ़्लो

क्लाइंट से रिकर्सिव रिज़ॉल्वर के माध्यम से GSLB इंटीग्रेशन के साथ आधिकारिक नेमसर्वर तक मानक DNS क्वेरी रिज़ॉल्यूशन।
...
F5 Distributed Cloud DNS प्रबंधन जो मल्टी-क्लाउड ऑरिजिन के पार बुद्धिमान DNS लोड बैलेंसिंग प्रदान करता है।
...
## DNS लोड बैलेंसिंग आर्किटेक्चर

क्लाउड क्षेत्रों के बीच भौगोलिक रूटिंग, हेल्थ चेक, और फेलओवर के साथ मल्टी-टियर DNS लोड बैलेंसिंग।
